...
export class RepositoriesService {
    ...
    public static listBranches(data: RepositoriesListBranchesData): CancelablePromise<RepositoriesListBranchesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
