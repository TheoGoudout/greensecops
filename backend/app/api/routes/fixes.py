...
from app.models import Analysis, Fix, FixPublic, FixStatus, Issue, Repository
...
def get_fix(
    ...
    return get_or_404(session, Fix, fix_id)
...
def trigger_workflow_delivery(
    ...
    deliver_fixes_batch.delay(
        ...
        pr_body="Automated batch of fixes generated by GreenSecOps.",
    )
...
def trigger_repo_delivery(
    ...
    deliver_fixes_batch.delay(
        ...
        pr_body="Automated batch of fixes for all workflow files generated by GreenSecOps.",
    )
    return {"status": "queued"}
