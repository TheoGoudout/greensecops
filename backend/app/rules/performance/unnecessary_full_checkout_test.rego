package greensecops.performance.unnecessary_full_checkout_test

import data.greensecops.performance.unnecessary_full_checkout
import rego.v1

test_violation_fetch_depth_zero_no_git_commands if {
	violations := unnecessary_full_checkout.violations with input as {"jobs": {"build": {"steps": [
		{
